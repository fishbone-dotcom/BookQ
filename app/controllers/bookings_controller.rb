class BookingsController < ApplicationController
  ...
  def create
    ...
    if starts_at.blank?
      ...
      if appointment.save
        @notice = "Na-book na ang appointment mo sa #{I18n.l(appointment.starts_at, format: :long)}."
      else
        @alert = appointment.errors.full_messages.to_sentence.presence || "Naunahan ka na — nabook na ng iba ang oras na 'yan."
      end
    end
